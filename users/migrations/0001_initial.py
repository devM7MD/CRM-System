    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('admin', 'Admin'), ('seller', 'Seller'), ('stock_keeper', 'Stock Keeper'), ('call_center_manager', 'Call Center Manager'), ('call_center_agent', 'Call Center Agent'), ('packaging', 'Packaging'), ('delivery', 'Delivery'), ('follow_up', 'Follow-up'), ('accountant', 'Accountant'), ('sourcing', 'Sourcing')], default='seller', max_length=30, verbose_name='role')),
