...
class PackagingRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ['barcode', 'tracking_number', 'order__order_code', 'packager__username', 'packager__first_name', 'packager__last_name']
...
class PackagingTaskAdmin(admin.ModelAdmin):
    ...
    search_fields = ['order__order_code', 'assigned_to__username', 'assigned_to__first_name', 'assigned_to__last_name', 'notes']
...
class PackagingQualityCheckAdmin(admin.ModelAdmin):
    ...
    search_fields = ['packaging_record__barcode', 'checker__username', 'checker__first_name', 'checker__last_name', 'notes']
